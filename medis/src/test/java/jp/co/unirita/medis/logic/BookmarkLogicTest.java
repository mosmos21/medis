...
@SpringBootTest
@Sql({"file:resources/sql/user_detail-insert.sql",
		"file:resources/sql/bookmark_bookmarklogictest-insert.sql",
		"file:resources/sql/update_info-insert.sql",
		"file:resources/sql/document_info_bookmarklogictest-insert.sql" })
